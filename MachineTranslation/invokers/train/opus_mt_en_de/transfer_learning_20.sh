...
python ${MAIN_DIRECTORY_PATH}/invokers/run_seq2seq.py \
    --model_name_or_path ${MAIN_DIRECTORY_PATH}/models/opus_mt_en_de_transfer_learning_10 \
    ...
    --output_dir ${MAIN_DIRECTORY_PATH}/models/opus_mt_en_de_transfer_learning_20 \
