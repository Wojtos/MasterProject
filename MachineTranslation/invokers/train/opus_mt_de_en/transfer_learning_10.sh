...
python ${MAIN_DIRECTORY_PATH}/invokers/run_seq2seq.py \
    --model_name_or_path ${MAIN_DIRECTORY_PATH}/models/opus_mt_de_en_transfer_learning_3 \
    ...
    --output_dir ${MAIN_DIRECTORY_PATH}/models/opus_mt_de_en_transfer_learning_10 \
