...
python ${MAIN_DIRECTORY_PATH}/invokers/run_seq2seq.py \
    --model_name_or_path ${MAIN_DIRECTORY_PATH}/models/t5_large_train_from_scratch_3 \
    --config_name ${MAIN_DIRECTORY_PATH}/configs/t5_large.json \
    ...
    --output_dir ${MAIN_DIRECTORY_PATH}/models/t5_large_train_from_scratch_10 \
